...
red,green,blue,neon = (255,0,0),(0,255,0),(0,0,255),(0, 200, 255)
class MakeTrail:
    def __init__(self,screen,how_many_lines = 100 ,screen_size=(1920,1080)):
        self.screen = screen
        self.lines_data = [Trail(red,self.screen) for i in range(how_many_lines)]
    ...
    def draw_lines(self,screen):
        ...
        # glow = pg.draw.circle(glow_surface,(*self.color,60),end_pos,5,5)
            ...
            the_line = pg.draw.circle(self.trail_surface,(*self.color,255),end_pos,2,2)
